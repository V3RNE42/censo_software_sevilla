...
**Salida:** `data/empresas.json` — 579 fichas

## Entrada / salida

- Fichas de entrada (raw/*.jsonl): **1429**
- Fichas de salida: **579**
- Filas absorbidas en fusión: **850** (59.5 % de la entrada)
- Fusiones (grupos con >1 fila): **120**

### Desglose por fuente (fichas que aportan)

- `E2_EMPLEO`: aporta a **892** fichas (82 en exclusiva)
...
- `SIN_MUNICIPIO`: 117
- `MUNICIPIO_FUERA_PROVINCIA`: 24
- `ES_ETT`: 8
- `DUPLICADO_POSIBLE`: 2

### DUPLICADO_POSIBLE — 1 pares (similitud ≥ 90, **no fusionados**, requieren revisión humana)

- 93.3 % · `sev-0124` S&H Consultores ↔ `sev-0132` SHS Consultores S.L

## Cobertura frente a DIRCE 2025

- DIRCE 2025, locales CNAE 62: Sevilla 1298, Málaga 2195, Huelva 111, total **3604**
- Censo fusionado: **579** fichas → **16.07 %** del universo DIRCE

Por provincia:

- Sevilla: 161 / 1298 = **12.40 %**
- Málaga: 339 / 2195 = **15.44 %**
- Huelva: 79 / 111 = **71.17 %**
